...
Citizen.CreateThread(
    function()
        local shops = { --These are the activation locations also makes sure when your done you go back to where you loaded!
            vector3(-325.52, 805.42, 117.88) -- Valintine General Store
